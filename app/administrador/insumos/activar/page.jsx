            ...
            <div className="md:flex md:items-center md:justify-between mb-6">
              <div className="flex-1 min-w-0">
                <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:truncate">
                  <button 
                    onClick={() => router.replace('/insumos')} 
            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-lg">
              <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
                <h3 className="text-lg leading-6 font-medium text-gray-900">
                  ...
                  {insumoFound ? 'Activar o Desactivar Insumo' : 'Buscar Insumo'}
                </h3>
                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                  {insumoFound 
                    ? 'Revise y active o desactive el insumo.'
                    : 'Ingrese el código de insumo para buscar un insumo.'}
                </p>
              ...
              {insumoFound && (
                <div className="mt-8 bg-white shadow overflow-hidden sm:rounded-lg">
                  <div className="px-4 py-5 sm:px-6">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">
                      Activar o desactivar Insumo
                    </h3>
                    <p className="mt-1 max-w-2xl text-sm text-gray-500">
                      Insumo: {dataSetForm?.nombre}
                    </p>
                    <p className="mt-1 max-w-2xl text-sm text-gray-500">
                      Codigo: {dataSetForm?.codigo}
                    </p>
                  </div>
