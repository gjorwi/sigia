  ...
  return (
    <div className="md:ml-64 px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="md:mt-6">
        <div className="sm:hidden p-2 px-3">
          <label htmlFor="tabs" className=" text-gray-800 text-lg">Selecciona una pestaña</label>
          <select
            id="tabs"
            name="tabs"
            className="block w-full pl-3 pr-10 py-2 text-gray-700 text-base border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
            value={activeTab}
