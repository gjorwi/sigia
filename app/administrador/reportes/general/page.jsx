...
export default function ReporteGeneral() {
  ...
  const handleGenerarReporte = () => {
    ...
    console.log('Generando reporte general para:', hospitalSeleccionado);
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
              <h3 className="text-lg leading-6 font-medium text-gray-900">
                <FileText className="h-5 w-5 inline-block mr-2 text-blue-500" />
                Reporte General
              </h3>
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Resumen completo de todas las operaciones del sistema
              </p>
            </div>
                ...
                <div>
                  ...
                  >
                    <input
                      ...
                      className="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 cursor-pointer bg-white"
                    />
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Selecciona el hospital para el cual deseas generar el reporte
                  </p>
                </div>
