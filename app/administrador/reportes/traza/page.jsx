...
export default function ReporteTrazaInsumo() {
  ...
  const handleGenerarReporte = () => {
    ...
    console.log('Generando reporte de traza de insumo para:', hospitalSeleccionado);
                ...
                <div>
                  ...
                  >
                    <input
                      ...
                      className="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-teal-500 focus:border-teal-500 cursor-pointer bg-white"
                    />
