...
import { ArrowLeft, Package, Download, Building2 } from 'lucide-react';
                ...
                <div>
                  ...
                  >
                    <input
                      ...
                      className="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-purple-500 focus:border-purple-500 cursor-pointer bg-white"
                    />
