          ...
          <div className="w-full">
            ...
            <div className="flex space-x-4 justify-center">
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 ${selectedRole === 'cliente'
              ...
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 ${selectedRole === 'administrador'
                  ? 'bg-white text-indigo-700 shadow-lg shadow-indigo-500/20'
                  : 'bg-white/10 text-white/80 hover:bg-white/20 border border-white/20'
                  }`}
              >
          ...
          <form className="w-full space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link href="/recuperar-contrasena" className="text-xs font-medium text-fuchsia-200 hover:text-white transition">¿Olvidó su contraseña?</Link>
              </div>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3">
